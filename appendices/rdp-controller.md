...
1. Download and run [this file](https://github.com/G1ANT-Robot/G1ANT.Manual/raw/develop/-assets/RDP local machine.reg) on your local Windows system, answering *Yes* to the security warning message.
